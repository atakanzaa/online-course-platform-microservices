...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({ 
  ...
  const handleDevelopmentMode = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      if (onError) {
        onError('Google OAuth geçici olarak devre dışı. Lütfen email/password ile giriş yapın.');
      }
    }, 1000);
  };
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        {isLoading ? 'Kontrol ediliyor...' : 'Google ile Devam Et (Geçici Olarak Devre Dışı)'}
      </button>
...
// Simple wrapper component for future Google OAuth integration
